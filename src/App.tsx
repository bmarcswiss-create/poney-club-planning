...
import { 
  Trash2, X, Plus, Edit, Lock, Unlock, Calendar, StickyNote, UserCog, CheckCircle2, Menu, Download, Info, Plane, GraduationCap, Check, Clock, UserPlus, ShieldCheck
} from 'lucide-react';
...
export default function App() {
  ...
  const [filtreEmploye, setFiltreEmploye] = useState(null); // Corrigé : Ajout du filtre manquant
